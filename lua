...
local function createUI()
    ...
    noclipBtn.MouseButton1Click:Connect(function()
        ...
        if noclipEnabled then
            noclipBtn.BackgroundColor3 = Color3.fromRGB(200, 150, 255)
            noclipBtn.Text = "👻 NOCLIP: ON"
        else
            noclipBtn.BackgroundColor3 = Color3.fromRGB(180, 120, 255)
    ...
    fastBtn.MouseButton1Click:Connect(function()
        ...
        if fastStealOn then
            fastBtn.BackgroundColor3 = Color3.fromRGB(255, 200, 120)
            fastBtn.Text = "⏩ FAST STEAL: ON"
        else
            fastBtn.BackgroundColor3 = Color3.fromRGB(255, 180, 100)
